      ...
      <div className="auth-container">
        <div className="auth-card">
          ...
          <div className="auth-form-section">
            ...
            <p className="auth-subtitle">Tham gia cùng cộng đồng yêu nội thất hiện đại.</p>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <p className="text-center mt-4 text-muted small mb-0">
                Đã có tài khoản? <Link to="/login" className="auth-link-strong">Đăng nhập tại đây</Link>
              </p>
            </form>
          </div>
        </div>
